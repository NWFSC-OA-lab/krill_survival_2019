...
treatLevels <- levels(dfAcclGoodMoats$treatment)
d$treatment <- relevel(d$treatment, ref = treatLevels[2])
...
#TODO summarize frailtyEM methods and results in manuscript format
...
# TODO fit the frailtyEM model fo the other survival estimate and plot curves
