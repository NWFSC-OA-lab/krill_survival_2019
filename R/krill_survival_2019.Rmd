...
color_pal <- c("limegreen", "mediumblue", "orange1")

p <- ggplot(dPlot, aes(time, survival_m)) +
  ...
  scale_color_manual(name = "Treatment", 
                       labels = c("Future Ocean", "Current Ocean", "Heat Wave"),
                       values = color_pal) +
...
ggsave(here("figs", "poster_plot_no_ci.jpeg"))
